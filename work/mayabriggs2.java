...
//                    " ENFJ ",
//            "A ENTJ (ENFJ) is a person with the Extraverted, Intuitive,"+
//"Feeling, and Judging personality traits. These warm, forthright types love helping others, and they tend to have"+
//"strong ideas and values. They back their perspective with the creative energy to achieve their goals."+
//
...
//
//                    " ENFP ",
//            """ A ENFP (ENFP) is someone with the Extraverted, Intuitive, Feeling, and Prospecting
//personality traits. These people tend to embrace big ideas and actions that reflect their sense of hope and goodwill
...
//
//                    "ENTJ",
//            "ENTJ personalities A (ENTJ) is someone with the Extraverted, Intuitive, Thinking,"+
//"and Judging personality traits. They are decisive people who love momentum and accomplishment."+
//"They gather information to construct their creative visions but rarely hesitate for long before acting on them."+
//"If there’s anything ENTJs love,it’s a good challenge, big or small, and they firmly believe that given enough time and"+
//"resources, they can achieve any goal. This quality makes people with the Commander personality"+
//"type brilliant entrepreneurs, and their ability to think strategically and hold a long-term focus while executing each"+
//"step of their plans with determination and precision makes them powerful business leaders."+
//
...
//
//                    "ISFP":
//            """ An ISFP (ISFP) is a person with the Introverted, Observant, Feeling,
//and Prospecting personality traits. They tend to have open minds, approaching life, new experiences, and people with
//grounded warmth. Their ability to stay in the moment helps them uncover exciting potentials.
//
...
//""",
//                    " ESTP ":
//            """ An ESTP ESTP is someone with the Extraverted, Observant, Thinking, and Prospecting
//personality traits. They tend to be energetic and action-oriented, deftly navigating whatever is in front of them.
...
//                    'ESTJ' :
//
//            """ An ESTJ (ESTJ) is someone with the Extraverted, Observant, Thinking, and Judging
//personality traits. They possess great fortitude, emphatically following their own sensible judgment. They often serve
...
//                    " ESFJ ":
//
//            """ A ESFJ (ESFJ) is a person with the Extraverted, Observant, Feeling, and Judging
//personality traits. They are attentive and people-focused, and they enjoy taking part in their social community.
...
//
//                    " ESFP ":
//            """ An ESFP ESFP is a person with the Extraverted, Observant, Feeling, and Prospecting
//personality traits. These people love vibrant experiences, engaging in life eagerly and taking pleasure in discovering
...
//
//                    " ISTP ":
//            """ ISTP is someone with the Introverted, Observant, Thinking,
//and Prospecting personality traits. They tend to have an individualistic mindset, pursuing goals without needing much
//external connection. They engage in life with inquisitiveness and personal skill, varying their approach as needed.
//
...
//
//                    " ISTJ ":
//            """ ISTJ A Logistician (ISTJ) is someone with the Introverted, Observant, Thinking,
//and Judging personality traits. These people tend to be reserved yet willful, with a rational outlook on life.
...
//
//                    " ISFJ ":
//            """ A ISFJ () is someone with the Introverted, Observant, Feeling,
...
//
//                    " INTJ ":
//            """ INTJ pesonality type An INTJ is a person with the Introverted, Intuitive, Thinking,
...
//everything they do. Their inner world is often a private, complex one. Rational and quick-witted, INTJs pride
//themselves on their ability to think for themselves, not to mention their uncanny knack for seeing right through
//phoniness and hypocrisy. But because their minds are never at rest, Architects may struggle to find people who can
//keep up with their nonstop analysis of everything around them.
//
...
//
//                    " INTP ":
//            """ INTP personalities A (INTP) is someone with the Introverted, Intuitive, Thinking,
//and Prospecting personality traits. These flexible thinkers enjoy taking an unconventional approach to
//many aspects of life. They often seek out unlikely paths,
//mixing willingness to experiment with personal creativity. INTP often lose themselves in thought –
//which isn’t necessarily a bad thing. People with this personality type hardly ever stop thinking. From the moment
//they wake up, their minds buzz with ideas, questions, and insights. At times, they may even find themselves
//conducting full-fledged debates in their own heads. People with this personality type want to understand everything
//in the universe, but one area in particular tends to mystify them: human nature. As their name suggests,
//Logicians feel most at home in the realm of logic and rationality. As a result, they can find themselves baffled by
//the illogical, irrational ways that feelings and emotions influence people’s behavior – including their own.
//
...
//
//                    " INFP ":
//            """ A  (INFP) is someone who possesses the Introverted, Intuitive, Feeling, and
//Prospecting personality traits. These rare personality types tend to be quiet, open-minded, and imaginative,
...
//                userResponses[i] = askQuestion(questions[i]);
//            }
//
//            String personalityType = "" +
//                    extrovertOrIntrovert(userResponses[0], userResponses[1]) +
//                    sensitiveOrIntuitive(userResponses[2], userResponses[3]) +
//                    thinkerOrFeeler(userResponses[4], userResponses[5]) +
//                    judgingOrPerspective(userResponses[6], userResponses[7]);
//
//            System.out.println(personalityType);
//            System.out.println("\n" + userName + ", your personality type is: " + personalityType);
//
//            int personalityIndex = -1;
//            for (int i = 0; i < personalityDescriptions.length; i++) {
//                if (personalityDescriptions[i].contains(personalityType)) {
//                    personalityIndex = i;
//                    break;
//                }
//            }
...
//                System.out.println(personalityDescriptions[personalityIndex]);
//            } else {
//                System.out.println("Personality type description not available yet or check entered response.");
//            }
//        }
//
